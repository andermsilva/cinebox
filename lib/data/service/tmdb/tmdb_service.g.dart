...
class _TmdbService implements TmdbService {
  ...
  @override
  Future<GenreRespose> getMoviesGenres({String language = 'pt-BR'}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'language': language};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GenreRespose>(
    ...
    late GenreRespose _value;
    try {
      _value = GenreRespose.fromJson(_result.data!);
    } on Object catch (e, s) {
